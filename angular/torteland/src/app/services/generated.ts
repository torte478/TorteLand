...
export class NotebooksClient {
  ...
  constructor(
    ...
    @Optional() @Inject(BASE_URL_TOKEN) baseUrl?: string
  ) {
    this.http = http;
  ...
  ): Observable<Int32IReadOnlyCollectionQuestionEither> {
          ...
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return _observableThrow(
                e
              ) as any as Observable<Int32IReadOnlyCollectionQuestionEither>;
            }
          } else
            return _observableThrow(
              response_
        ...
        _observableMergeMap((_responseText: string) => {
          ...
          let resultData200 =
            _responseText === ''
              ...
              : JSON.parse(_responseText, this.jsonParseReviver);
          result200 =
            Int32IReadOnlyCollectionQuestionEither.fromJS(resultData200);
          return _observableOf(result200);
        })
      );
    } else if (status !== 200 && status !== 204) {
  ...
  startActualize(
    ...
    let url_ = this.baseUrl + '/Notebooks/StartActualize?';
    if (notebookId === null)
    ...
    if (valueId === null)
      throw new Error("The parameter 'valueId' cannot be null.");
    ...
    return this.http
      ...
      .pipe(
        _observableMergeMap((response_: any) => {
          return this.processStartActualize(response_);
        })
      )
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              return this.processStartActualize(response_ as any);
            } catch (e) {
              return _observableThrow(
                e
              ) as any as Observable<Int32IReadOnlyCollectionQuestionEither>;
  ...
  protected processStartActualize(
    response: HttpResponseBase
  ): Observable<Int32IReadOnlyCollectionQuestionEither> {
    const status = response.status;
    const responseBlob =
      ...
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            ...
            return _observableThrow(
              response_
            ) as any as Observable<ByteInt32Either>;
        })
      );
  }

  protected processIncrement(
    response: HttpResponseBase
  ): Observable<ByteInt32Either> {
    const status = response.status;
    const responseBlob =
      ...
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            ...
            return _observableThrow(
              response_
            ) as any as Observable<StringUniquePage>;
        })
      );
  }
      ...
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            ...
            return _observableThrow(
              response_
            ) as any as Observable<StringMaybe>;
        })
      );
  }
...
export class Int32IReadOnlyCollectionQuestionEither
  implements IInt32IReadOnlyCollectionQuestionEither
{
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['left'])) {
        this.left = [] as any;
        for (let item of _data['left']) this.left!.push(item);
      }
      this.right = _data['right']
        ? Question.fromJS(_data['right'])
        : <any>undefined;
    }
  }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.left)) {
      data['left'] = [];
      for (let item of this.left) data['left'].push(item);
    }
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['items'])) {
        this.items = [] as any;
        for (let item of _data['items']) this.items!.push(Note.fromJS(item));
      }
